...
/**
 * Created by anmol-5732 on 01/03/18.
 */
...
public class ZoomEditTextView extends AppCompatEditText {
    ...
    private void init() {
        ...
        mDrawable = mContext.getResources().getDrawable(R.drawable.ic_launcher_background);
